...
import ChatTag from "../ChatTag/chattag.component";
    ...
    <div className="w-[25%] right-10 top-10 bg-[#ffffff] rounded-md shadow-sm shadow-[#ffffff94] fixed h-[94vh] flex justify-between flex-col">
      ...
      <div className="h-[75%] overflow-y-auto">
        <div className="w-full p-3">
          <ChatTag data = {{role : "assistant", content : "Please not that if chatGPT takes more than 10 seconds to response, then netlify will reject the request. To start, you can ask about the paper in 50 words."}} />
          {
            chat.map(data => (
              <ChatTag data = {data}/>
            ))
